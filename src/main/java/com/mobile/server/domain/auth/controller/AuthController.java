...
public class AuthController {
    ...
    public ResponseEntity<CheckDuplicationRes> checkStudentId(@RequestParam String studentId) {
    ...
    public ResponseEntity<CheckDuplicationRes> checkNickname(@RequestParam String nickname) {
